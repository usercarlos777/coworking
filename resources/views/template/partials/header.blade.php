            ...
            <div class="header-dots">
                ...
                <div class="btn-group b-dropdown dropdown" id="__BVID__16">
                    ...
                    <div
                        ...
                        ruta="{{route('check.notificaciones')}}"
                        role="menu" 
                        tabindex="-1" 
                                                                ...
                                                                <div>
                                                                    <span class="vertical-timeline-element-icon bounce-in">
                                                                        @if($notificacion->estado == 'Nueva')
                                                                            <i style="display: inline-block;" class="badge badge-dot badge-dot-xl badge-danger"></i>
                                                                        @else
                                                                            <i style="display: inline-block; background-color: gray;" class="badge badge-dot badge-dot-xl"></i>
                                                                        @endif
                                                                    </span>
                                                                    <div class="vertical-timeline-element-content bounce-in">
                                                                        <p>{{$notificacion->descripcion}}</p>
                                                                        <a href="{{$notificacion->url}}">Ver más</a>
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-info">
                                            <div class="menu-header-image opacity-7" style="background-image: url('{{Auth::user()->banner()}}');"></div>
                                    ...
                                    <ul class="nav flex-row" style="justify-content: space-around;">
                                        ...
                                        <li class="nav-item-btn text-center nav-item">
                                            <a class="btn-wide btn btn-primary btn-sm" href="{{ route('perfil') }}">
                                                Mi perfil
                                            </a>
                                        </li>
                                    </ul>
